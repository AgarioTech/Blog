async function setPostBookmark(element) {
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/v1/posts/${post_id}/bookmark/`, {
            method: 'POST',
            headers: {
...
async function setCommentBookmark(element) {
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/v1/comments/${comment_id}/set-bookmark/`, {
            method: 'POST',
            credentials: 'include',
            headers: {
                'Content-Type': 'application/json',
...
async function initCommentBookmarks() {
    ...
    for (const img of bookmarkWrapper) {
        ...
        try {
            const response = await fetch(`${BASE_URL}/api/v1/comments/${comment_id}/`, {
                method: 'GET',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
